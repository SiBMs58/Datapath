...
DP_OPERATIONS = [
('zero' , pattern((('op', 'zero'), ('rd', register())), can_have_label=True),                                                       "zero rd            -->  $rd := 0",                          lambda m, params : '000'+'0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'000'+'000' ),
('not'  , pattern((('op', 'not'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "not rd rs          -->  $rd := ! $rs",                      lambda m, params : '001'+'0001'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('inv'  , pattern((('op', 'inv'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "inv rd rs          -->  $rd := - $rs",                      lambda m, params : '001'+'1010'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('sll'  , pattern((('op', 'sll'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sll rd rs          -->  $rd := $rs << 2",                   lambda m, params : '001'+'1011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('srl'  , pattern((('op', 'srl'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "srl rd rs          -->  $rd := $rs >> 2",                   lambda m, params : '001'+'1100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('sla'  , pattern((('op', 'sla'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sla rd rs          -->  $rd := $rs * 2",                    lambda m, params : '001'+'1101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('sra'  , pattern((('op', 'sra'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sra rd rs          -->  $rd := $rs / 2",                    lambda m, params : '001'+'1110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('inc'  , pattern((('op', 'inc'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "inc rd rs          -->  $rd := $rs + 1",                    lambda m, params : '001'+'0100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('dec'  , pattern((('op', 'dec'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "dec rd rs          -->  $rd := $rs - 1",                    lambda m, params : '001'+'0101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('cp'   , pattern((('op', 'cp'),   ('rd', register()), ('rs', register())), can_have_label=True),                                   "cp rd rs           -->  $rd := $rs",                        lambda m, params : '001'+'1111'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'000' ),
('and'  , pattern((('op', 'and'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "and rd rs rt       -->  $rd := $rs & $rt",                  lambda m, params : '010'+'0010'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('or'   , pattern((('op', 'or'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "or rd rs rt        -->  $rd := $rs | $rt",                  lambda m, params : '010'+'0011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('add'  , pattern((('op', 'add'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "add rd rs rt       -->  $rd := $rs + $rt",                  lambda m, params : '010'+'0100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('sub'  , pattern((('op', 'sub'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "sub rd rs rt       -->  $rd := $rs - $rt",                  lambda m, params : '010'+'0101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lt'   , pattern((('op', 'lt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "lt rd rs rt        -->  $rs < $rt ? $rd := 1 : $rd := 0",   lambda m, params : '010'+'0110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('gt'   , pattern((('op', 'gt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "gt rd rs rt        -->  $rs > $rt ? $rd := 1 : $rd := 0",   lambda m, params : '010'+'0111'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('eq'   , pattern((('op', 'eq'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "eq rd rs rt        -->  $rs = $rt ? $rd := 1 : $rd := 0",   lambda m, params : '010'+'1000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('neq'  , pattern((('op', 'neq'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "neq rd rs rt       -->  $rs != $rt ? $rd := 1 : $rd := 0",  lambda m, params : '010'+'1001'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lw'   , pattern((('op', 'lw'),   ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "lw rd rs uimm      -->  $rd := MEM[$rs + imm]",             lambda m, params : '011'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
('sw'   , pattern((('op', 'sw'),   ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "sw rd rs uimm      -->  MEM[$rs + imm] := $rd",             lambda m, params : '011'+'1'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "ori rd imm      -->  rd := rd | imm",               lambda m, params : '100'+'00'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "ori rd imm      -->  rd := rd | imm",               lambda m, params : '100'+'00'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),8)) ),
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "lui rd imm      -->  rd := imm << 8",               lambda m, params : '100'+'01'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "lui rd imm      -->  rd := imm << 8",               lambda m, params : '100'+'01'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),8)) ),
('addi' , pattern((('op', 'addi'), ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "addi rd imm     -->  rd := rd + imm",               lambda m, params : '100'+'10'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('addi' , pattern((('op', 'addi'), ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "addi rd imm     -->  rd := rd + imm",               lambda m, params : '100'+'10'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),8)) ),
('subi' , pattern((('op', 'subi'), ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "subi rd imm     -->  rd := rd + imm",               lambda m, params : '100'+'11'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('subi' , pattern((('op', 'subi'), ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "subi rd imm     -->  rd := rd + imm",               lambda m, params : '100'+'11'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),8)) ),
]

# extra full data path operations
# (name, parse_pattern, help_string, compile_function)
FULL_DP_OPERATIONS = [
('beq'  , pattern((('op', 'beq'),  ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "beq rd rs imm   -->  rd==rs ? pc := pc+1+imm",     lambda m, params : '101'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
('beq'  , pattern((('op', 'beq'),  ('rd', register()), ('rs', register()), ('to', labelpattern())), can_have_label=True),           "beq rd rs imm   -->  rd==rs ? pc := pc+1+imm",     lambda m, params : '101'+'0'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),6,params[1],params[0]-1)) ),
('blt'  , pattern((('op', 'blt'),  ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "blt rd rs imm   -->  rd<rs ? pc := pc+1+imm",      lambda m, params : '101'+'1'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
('blt'  , pattern((('op', 'blt'),  ('rd', register()), ('rs', register()), ('to', labelpattern())), can_have_label=True),           "blt rd rs imm   -->  rd<rs ? pc := pc+1+imm",      lambda m, params : '101'+'1'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),6,params[1],params[0]-1)) ),
#('brnz' , pattern((('op', 'brnz'), ('rd', register()),  ('imm', integerpattern())), can_have_label=True),                           "brnz rd imm     -->  rd!=0 ? pc := pc+1+imm",      lambda m, params : '1101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
#('brnz' , pattern((('op', 'brnz'), ('rd', register()),  ('to', labelpattern())), can_have_label=True),                              "brnz rd imm     -->  rd!=0 ? pc := pc+1+imm",      lambda m, params : '1101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),6,params[1],params[0]-1)) ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', binarypattern(8))), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '110'+'00'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm')),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '110'+'00'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),8)) ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('to', labelpattern())), can_have_label=True),                               "jr rd imm       -->  pc := rd+imm",                lambda m, params : '110'+'00'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),8,params[1])) ),
('j'    , pattern((('op', 'j'),    ('addr', binarypattern(12))), can_have_label=True),                                              "j addr          -->  pc := addr",                  lambda m, params : '111'+'0'+m.group('addr') ),
('j'    , pattern((('op', 'j'),    ('addr', uintegerpattern())), can_have_label=True),                                              "j addr          -->  pc := addr",                  lambda m, params : '111'+'0'+str(uint2bin(m.group('addr'),12)) ),
('j'    , pattern((('op', 'j'),    ('to', labelpattern())), can_have_label=True),                                                   "j addr          -->  pc := addr",                  lambda m, params : '111'+'0'+str(label2bin(m.group('to'),12,params[1])) ),
('jal'  , pattern((('op', 'jal'),  ('addr', binarypattern(12))), can_have_label=True),                                              "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '111'+'1'+m.group('addr') ),
('jal'  , pattern((('op', 'jal'),  ('addr', uintegerpattern())), can_have_label=True),                                              "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '111'+'1'+str(uint2bin(m.group('addr'),12)) ),
('jal'  , pattern((('op', 'jal'),  ('to', labelpattern())), can_have_label=True),                                                   "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '111'+'1'+str(label2bin(m.group('to'),12,params[1])) ),
]
